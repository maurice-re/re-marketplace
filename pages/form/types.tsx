...
const BusinessTypesPage: NextPage = () => {
  ...
  const { activateRoute, deactivateRoute, getCity, locations } = useFormStore(
    (state) => ({
  ...
  const pageName: string = router.asPath.slice(6);

  return (
    <div className="w-screen h-screen bg-black flex">
      <Head>
        <title>What types of food</title>
        <meta name="types" content="Generated by create next app" />
