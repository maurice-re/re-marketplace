...
function HomeContentFull({ locations, user, skus, head }: { locations: Location[]; user: UserOrderItems; skus: SkuProduct[]; head: JSX.Element; }) {
...
export default HomeContentFull;