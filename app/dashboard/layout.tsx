...
export default async function Layout({
  ...
  if (hasCompleteOrder) {
    routes.splice(0, 0,
      {
        icon: (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3.75 9.9375V21C3.75 21.1989 3.82902 21.3897 3.96967 21.5303C4.11032 21.671 4.30109 21.75 4.5 21.75H9V15.375C9 15.0766 9.11853 14.7905 9.3295 14.5795C9.54048 14.3685 9.82663 14.25 10.125 14.25H13.875C14.1734 14.25 14.4595 14.3685 14.6705 14.5795C14.8815 14.7905 15 15.0766 15 15.375V21.75H19.5C19.6989 21.75 19.8897 21.671 20.0303 21.5303C20.171 21.3897 20.25 21.1989 20.25 21V9.9375" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M22.5 12L12.5105 2.43747C12.2761 2.18997 11.7281 2.18716 11.4895 2.43747L1.5 12M18.75 8.3906V2.99997H16.5V6.23435" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        ),
        link: "/dashboard",
        title: "Home",
      ...
      {
        icon: (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M21 16.0017V7.99733C20.9997 7.73534 20.9308 7.47801 20.8001 7.25095C20.6694 7.02388 20.4815 6.835 20.2552 6.70311L13.1302 2.55655C12.7869 2.35669 12.3968 2.2514 11.9995 2.2514C11.6023 2.2514 11.2122 2.35669 10.8689 2.55655L3.74484 6.70311C3.51848 6.835 3.33061 7.02388 3.19993 7.25095C3.06925 7.47801 3.00032 7.73534 3 7.99733V16.0017C3.00016 16.2638 3.06901 16.5214 3.1997 16.7486C3.33038 16.9759 3.51834 17.1649 3.74484 17.2969L10.8698 21.4434C11.2132 21.643 11.6033 21.7481 12.0005 21.7481C12.3976 21.7481 12.7877 21.643 13.1311 21.4434L20.2561 17.2969C20.4824 17.1648 20.6702 16.9757 20.8007 16.7485C20.9312 16.5212 20.9999 16.2638 21 16.0017Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M3.23438 7.21826L12 12.3745L20.7656 7.21826M12 21.7495V12.3745" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
        </svg>),
      ...
      {
        icon: (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2.25C8.27344 2.25 5.25 5.12766 5.25 8.67188C5.25 12.75 9.75 19.2127 11.4023 21.4448C11.4709 21.5391 11.5608 21.6157 11.6647 21.6686C11.7686 21.7215 11.8835 21.749 12 21.749C12.1165 21.749 12.2314 21.7215 12.3353 21.6686C12.4392 21.6157 12.5291 21.5391 12.5977 21.4448C14.25 19.2136 18.75 12.7533 18.75 8.67188C18.75 5.12766 15.7266 2.25 12 2.25Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M12 11.25C13.2426 11.25 14.25 10.2426 14.25 9C14.25 7.75736 13.2426 6.75 12 6.75C10.7574 6.75 9.75 7.75736 9.75 9C9.75 10.2426 10.7574 11.25 12 11.25Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        ),
    ...
    routes.splice(6, 0, {
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M16.125 6.75C15.9412 9.22828 14.0625 11.25 12 11.25C9.93748 11.25 8.05545 9.22875 7.87498 6.75C7.68748 4.17188 9.5156 2.25 12 2.25C14.4844 2.25 16.3125 4.21875 16.125 6.75Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M12 14.25C7.92187 14.25 3.7828 16.5 3.01687 20.7469C2.92452 21.2588 3.21421 21.75 3.74999 21.75H20.25C20.7862 21.75 21.0759 21.2588 20.9836 20.7469C20.2172 16.5 16.0781 14.25 12 14.25Z" stroke="white" strokeMiterlimit="10" />
        </svg>
      ),
