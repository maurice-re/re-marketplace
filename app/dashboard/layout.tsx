...
export default async function Layout({
  ...
  if (hasCompleteOrder) {
    routes.splice(
      ...
      0,
      {
        icon: (
          ...
          >
            ...
            />
            <path
              d="M22.5 12L12.5105 2.43747C12.2761 2.18997 11.7281 2.18716 11.4895 2.43747L1.5 12M18.75 8.3906V2.99997H16.5V6.23435"
              stroke="white"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M12 4.5V2.625M12 21.375V19.5"
              stroke="white"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
    ...
    routes.splice(6, 0, {
      icon: (
        ...
        >
          <path
            d="M16.125 6.75C15.9412 9.22828 14.0625 11.25 12 11.25C9.93748 11.25 8.05545 9.22875 7.87498 6.75C7.68748 4.17188 9.5156 2.25 12 2.25C14.4844 2.25 16.3125 4.21875 16.125 6.75Z"
            stroke="white"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
  ...
  return (
    <div className="flex flex-grow bg-re-black h-full">
      <div className="flex flex-col items-center text-white px-8 border-r-1/2 border-re-gray-300 h-screen">
        <div className="w-full flex items-center justify-center gap-20 mt-6 mb-8">
          ...
          <div className="avatar placeholder">
            <div className="bg-re-green-500 text-black rounded-full w-8">
              <span className="text-md">{user.firstName?.charAt(0)}</span>
            </div>
          </div>
        </div>
