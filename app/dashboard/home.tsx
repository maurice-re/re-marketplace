...
function Home({
  ...
  // TODO(Suhana): Uncomment after testing
  // if (hasCompleteOrder) {
  //   return (
  ...
  if (hasIncompleteOrder) {
    ...
    const progress: Status[] = (statuses.slice(0)).splice(0, ((statuses.slice(0)).indexOf(incompleteOrders[0].items[0].status) + 1));

    return (
      <div className="w-full h-screen w-7/8 bg-black flex overflow-auto">
        {/* {head} */}
        <main className="flex flex-col w-full container mx-auto py-6 text-white font-theinhardt">
          <div className="flex justify-between px-1">
            <h1 className="ml-1 font-theinhardt text-3xl">{`Hi ${user.companyId == "616" ? "Agent Coulson" : user.firstName
              }!`}</h1>
            <div className="flex items-center">
