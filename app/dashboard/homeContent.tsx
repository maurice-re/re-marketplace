"use client";
import { addDays, ItemLocationSku, ItemLocationSkuProduct, separateByLocationId, skuName, SkuProduct, UserOrderItems } from "../../utils/dashboard/dashboardUtils";
...
function HomeContent({ locations, user, skus, hasCompleteOrder, hasIncompleteOrder }: { locations: Location[]; user: UserOrderItems; skus: SkuProduct[]; hasCompleteOrder: boolean; hasIncompleteOrder: boolean; }) {
