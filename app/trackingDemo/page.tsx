...
import { authOptions } from '../dashboard/tracking/../../../pages/api/auth/[...nextauth]';
        ...
        <Link href={"/dashboard"}>
          <button className='w-full mb-8 flex items-center justify-start gap-2'>
            <svg width="7" height="15" viewBox="0 0 7 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.4637 2.4593L2.923 9L9.4637 15.5408C9.5126 15.5896 9.5553 15.6422 9.5919 15.6976C9.8482 16.0858 9.8054 16.6133 9.4637 16.955C9.0732 17.3455 8.4401 17.3455 8.0495 16.955L0.801679 9.7071C0.614149 9.5196 0.508789 9.2653 0.508789 9C0.508789 8.7348 0.614149 8.4805 0.801679 8.2929L8.0495 1.04509C8.4401 0.654567 9.0732 0.654567 9.4637 1.04509C9.8543 1.43561 9.8543 2.06878 9.4637 2.4593Z" fill="#58FEC4" />
            </svg>
            <h2 className='active:opacity-80 text-white font-theinhardt-300 text-md'>Back to dashboard</h2>
          </button>
        </Link>
        <div className='w-full flex justify-between'>
          <h3 className='w-7/8 font-theinhardt-300 text-white text-xl'>Unlock tracking insights like these and more metric customization options by integrating with our tracking API.</h3>
