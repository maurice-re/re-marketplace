...
import { ItemLocationSku, FullOrderLocationSku } from "../dashboard/dashboardUtils";
...
export function getItemsFromOrder(orders: FullOrderLocationSku[]): ItemLocationSku[] {
